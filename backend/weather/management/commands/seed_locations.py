...
LOCATIONS = [
    ...
    # ─── Major Cities ───
    ("New York City", 40.7128, -74.0060, "US", "city", ["NYC", "Big Apple", "Manhattan", "New York"]),
    ...
    ("Colosseum", 41.8902, 12.4922, "IT", "landmark", ["Roman Colosseum", "Flavian Amphitheatre"]),
    ("Taj Mahal", 27.1751, 78.0421, "IN", "landmark", []),
    ("Great Pyramids of Giza", 29.9792, 31.1342, "EG", "landmark", ["The Great Pyramids", "Pyramids of Egypt", "Giza Pyramids"]),
    ...
    ("Sagrada Família", 41.4036, 2.1744, "ES", "landmark", ["Sagrada Familia", "Gaudí's Cathedral"]),
    ...
    ("Acropolis", 37.9715, 23.7267, "GR", "landmark", ["Acropolis of Athens", "Parthenon"]),
    ...
    ("Mount Everest", 27.9881, 86.9250, "NP", "landmark", ["Sagarmatha", "Chomolungma"]),
