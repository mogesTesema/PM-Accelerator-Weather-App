...
A production-grade, AI-powered weather intelligence system engineered for the **PM Accelerator AI assessment**. This backend exposes a highly scalable RESTful API built with Django, powered by full CRUD operations, multi-format exports, and an autonomous LLM orchestration layer that fetches and contextualizes weather, location, and multimedia data in real-time.
